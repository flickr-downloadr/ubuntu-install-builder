...
ENV INSTALLBUILDER_VERSION 23.11.0
...
RUN apt-get update && \
    ...
    wget -O installbuilder.run https://releases.installbuilder.com/installbuilder/installbuilder-enterprise-$INSTALLBUILDER_VERSION-linux-x64-installer.run && \
